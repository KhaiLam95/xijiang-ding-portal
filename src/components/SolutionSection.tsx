...
const SolutionSection = () => {
  ...
  const solutions = language === 'zh' ? [
  ...
  ] : [
    {
      id: "fintech",
      title: "Fintech",
      description: "Providing intelligent risk control, personalized services, and digital transformation solutions for financial institutions through AI technology and data analysis.",
      image: "https://images.unsplash.com/photo-1620714223084-8fcacc6dfd8d?q=80&w=2000&auto=format&fit=crop",
      path: "/solutions/fintech"
    },
    {
      id: "healthcare",
      title: "Healthcare",
      description: "Combining AI and big data technology to provide intelligent diagnosis, telemedicine, and health management platforms to improve medical service efficiency and quality.",
      image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?q=80&w=2000&auto=format&fit=crop",
      path: "/solutions/healthcare"
    },
    {
    ...
    },
    {
      id: "smartcity",
      title: "Smart City",
      description: "Providing comprehensive smart city solutions for city managers to optimize urban operations and improve the quality of life for citizens.",
      image: "https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=2000&auto=format&fit=crop",
      path: "/solutions/smartcity"
    }
  ];
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            {language === 'zh' 
              ...
              : 'We deeply understand the pain points of various industries and provide professional, personalized solutions to meet the specific needs of different sectors.'}
          </p>
        </div>
